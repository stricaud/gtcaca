...
static void minibuffer_complete_command(void)
{
...
static void start_mx(void) { start_minibuffer_init("M-x ", mx_done, 2, NULL); }  /* 2 = command completion */
